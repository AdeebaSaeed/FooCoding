...
function fetchPokemonData() {
  ...
  /* Code goes below */
  const pokemonDataObject = JSON.parse(fetchPokemonData());
console.log(pokemonDataObject);

//DOM Part to display images
...
const arrayOfSpritesImages = Object.values(sprites);
const pokeApi = arrayOfSpritesImages.filter(item => !!item);

pokeApi.forEach(poke => {
