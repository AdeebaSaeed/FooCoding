...
CREATE TABLE `reminder` (
  ...
  `reminder_item_id` int(11) NOT NULL,
  PRIMARY KEY (`reminder_id`),
  UNIQUE KEY `reminder_id_UNIQUE` (`reminder_id`),
  UNIQUE KEY `reminder_item_id_UNIQUE` (`reminder_item_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `todo_list` (
  `idtodo_list` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `caption` varchar(45) NOT NULL,
  `purpose` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idtodo_list`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-06-02  0:12:08
